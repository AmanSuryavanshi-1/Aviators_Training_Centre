        ...
        <div className="relative py-16 min-h-[60vh] flex items-center overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-white">
              ...
              <h1 className="text-5xl font-heading font-bold mb-6 leading-tight drop-shadow-lg">
                {post.title}
              </h1>
              
              {post.excerpt && (
                <p className="text-xl text-white/90 mb-8 leading-relaxed max-w-3xl drop-shadow-md font-semibold">
                  {post.excerpt}
                </p>
              )}
