...
function ContactPageContent() {
  ...
  const isDemoBooking = searchParams
    ? searchParams.get("demo") === "true"
    : false;

  // Safely handle potential null values for query parameters
  const initialSubjectParam = searchParams
    ? searchParams.get("subject") || ""
    : "";
  const courseNameParam = searchParams
    ? searchParams.get("courseName") || ""
    : "";
  const nameParam = searchParams ? searchParams.get("name") || "" : "";

  const emailParam = searchParams ? searchParams.get("email") || "" : "";
  const phoneParam = searchParams ? searchParams.get("phone") || "" : "";
  const messageParam = searchParams ? searchParams.get("message") || "" : "";
  ...
  useEffect(() => {
    ...
    emailParam,
    phoneParam,
  ]); // Dependencies include all params read
    ...
    <>
      ...
      <main className="flex-grow container mx-auto px-4 sm:px-6 py-16 md:py-24 space-y-20 md:space-y-28">
            ...
            <motion.div /* Add variants */ className="lg:col-span-2">
              <Card className="bg-card h-full rounded-lg shadow-sm border border-border p-6 md:p-8">
                <CardHeader className="p-0 mb-6">
                  <CardTitle
                    className={cn("text-2xl font-semibold", aviationPrimary)}
                  >
                    Contact Details
                  </CardTitle>
                ...
                <CardContent className="p-0 space-y-5">
                  ...
                  <div className="flex items-start space-x-3">
                    <div
                      className={cn(
                        "flex-shrink-0 mt-1 p-2 rounded-full bg-teal-100/70 dark:bg-teal-900/40",
                        aviationSecondary,
                      )}
                    >
                    ...
                    <div>
                      ...
                      {/* Link to Google Maps */}
                      <a
                        href="https://www.google.com/maps/search/?api=1&query=Ramphal+Chowk+Rd,+Sector+7+Dwarka,+Dwarka,+Delhi,+110075"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-sm text-foreground/80 hover:text-primary transition-colors"
                      >
                        Ramphal Chowk Rd, Sector 7 Dwarka,
                        <br />
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="block text-sm text-foreground/80 hover:text-primary transition-colors underline-offset-2 hover:underline break-all"
                      >
                        aviatorstrainingcentre@gmail.com
                      </a>
                      <a
                        href="mailto:info@aviatorstrainingcentre.in"
                        className="block text-sm text-foreground/80 hover:text-primary transition-colors underline-offset-2 hover:underline break-all"
                      >
                        info@aviatorstrainingcentre.in
                      </a>
                    </div>
                  </div>
                  {/* Operating Hours */}
                    ...
                    <div>
                      ...
                      <dl className="text-sm text-foreground/80">
                        <div className="flex justify-between">
                          <dt>Mon - Fri:</dt>
                          <dd className="pl-2">8:00 AM - 7:00 PM</dd>
                        </div>
                        <div className="flex justify-between">
                          <dt>Saturday:</dt>
                          <dd className="pl-2">9:00 AM - 5:00 PM</dd>
                        </div>
                        <div className="flex justify-between">
                          <dt>Sunday:</dt>
                          <dd className="pl-2">10:00 AM - 4:00 PM</dd>
                        </div>
                      </dl>
                    </div>
                  </div>
                  ...
                  <div className="pt-4 border-t border-border/50">
                    ...
                    <div className="flex space-x-2">
                      ...
                      >
                        ...
                        <a
                          href="https://www.facebook.com/profile.php?id=61557303895431"
                          target="_blank"
                          rel="noopener noreferrer"
                          aria-label="Facebook"
                        >
                      ...
                      >
                        {/* Use anchor tag for external link */}
                        <a
                          href="https://www.instagram.com/aviatorstrainingcentre/"
                          target="_blank"
                          rel="noopener noreferrer"
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
            ...
            >
              ...
              >
                Feel free to reach out to us via the contact information below
                or the form above. We are always happy to help!
              </motion.p>
        ...
        >
          ...
          >
            Visit our training centre in Dwarka, New Delhi, to discuss your
            training needs in person.
          </motion.p>
